...
python2 ../evaluation/run_evaluation.py --predictions_folder res --data_folder ../../../sorted_data/small_days_data --out_folder evaluation/exp_weighted --type expect_weighted_classification
...
python2 ../evaluation/run_evaluation.py --predictions_folder res --data_folder ../../../sorted_data/small_days_data --out_folder evaluation/exp_argmax --type expect_argmax_classification
