...
def evaluate_regression(predictions_folder, data_folder, out_folder):
    ...
    with open(os.path.join(out_folder, "metrics.txt"), "w") as handler:
        for predictions_filename, data_filename in zip(predictions_filenames, data_filenames):
            ...
            predicted_positions = np.argmax(predictions, axis=1)
            ...
            print("target_posisions", target_positions)
