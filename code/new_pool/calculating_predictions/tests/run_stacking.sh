...
python2 run.py --data_folder ../../../sorted_data/small_days_data --out_folder tests/stacking_res --model catboost --type linear_stacking --verbose --fast --max_clicks 5 --linear_predictions tests/res
