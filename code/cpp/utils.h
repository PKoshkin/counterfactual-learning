...
const std::vector<std::string> KRKOPT_ANSWERS = {"draw", "zero", "one", "two", "three", "four", "five", "six",
    "seven", "eight", "nine", "ten", "eleven", "twelve", "thirteen", "fourteen", "fifthteen", "sixteen"};
...
std::pair<Pool, Pool> train_test_split(const Pool& pool, double train_share, uint32_t random_seed = -1);
